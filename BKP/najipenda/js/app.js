...
const products = [
  ...
  {id:12,name:"Digital Naji Scale Precision 5kg",        brand:"PrecisionPro",  price:1299,  oldPrice:1799,  cat:"baking",   rating:4.7, reviews:1230, emoji:"⚖️", img:IMG.baking[3],   stock:42, isNew:true,  isBest:false, disc:28, colors:["Black","White"],      sizes:[]},
  {id:13,name:"Silicone Naji Utensil Set 10-Piece",      brand:"FlexiCook",     price:1799,  oldPrice:2499,  cat:"utensils", rating:4.7, reviews:2341, emoji:"🥄", img:IMG.utensils[0], stock:89, isNew:false, isBest:true,  disc:28, colors:["Black","Red","Teal"],  sizes:[]},
  {id:14,name:"Wooden Spoon Set 5-Piece Bamboo",            brand:"NaturalNaji",price:899,   oldPrice:1299,  cat:"utensils", rating:4.5, reviews:1876, emoji:"🥄", img:IMG.utensils[1], stock:120,isNew:false, isBest:false, disc:31, colors:[],                     sizes:[]},
  ...
  {id:20,name:"Bamboo Serving Tray with Handles",           brand:"NaturalNaji",price:1299,  oldPrice:1799,  cat:"dining",   rating:4.5, reviews:712,  emoji:"🍱", img:IMG.dining[3],   stock:43, isNew:true,  isBest:false, disc:28, colors:[],                     sizes:[]},
...
function renderCartItems(){
  ...
  if(!cart.length){
    el.innerHTML=`<div class="empty-state"><div class="empty-icon">🛒</div><h3>Your cart is empty</h3><p>Discover amazing Naji products</p><a href="ecommerce.html" class="btn btn-primary">Start Shopping</a></div>`;
